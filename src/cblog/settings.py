...
DATABASES = {
    'default': {
        ...
        'HOST': 'aws-capstone-rds.cy3y2x8kruyq.us-east-1.rds.amazonaws.com',  # database endpoint is written here
...
AWS_STORAGE_BUCKET_NAME = 'awscapstonesademblog' # please enter your s3 bucket name
